    ...
    useEffect(() =>{
        ...
        const fetchUserHistory = async () => {
            if(authState && authState.isAuthenticated){
                ...
                const historyResponce = await fetch(url, requestOptions);

                if(!historyResponce.ok){
                    throw new Error("Something went wrong with history");
                }

                const historyResponceJson = await historyResponce.json();

                setHistories(historyResponceJson._embedded.histories);
                setTotalPages(historyResponceJson.page.totalPages);
                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col">
                                            <div className="card-body">
                                                ...
                                                <hr />
                                                <p className="card-text">Checkout out on: {history.checkoutDate}</p>
