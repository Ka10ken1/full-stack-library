...
export const Loans = () => {
        ...
        const fetchUserCurrentLoans = async () => {
            if (authState && authState.isAuthenticated) {
                try {
                    ...
                    if (!response.ok) {
                        throw new Error("Something went wrong with current loans");
                    }
    ...
    const returnBook = async (bookId: number) => {
        try {
            ...
            if (!response.ok) {
                throw new Error("Something went wrong with return");
            }
    ...
    const renewLoan = async (bookId: number) => {
        try {
            ...
            if (!response.ok) {
                throw new Error("Something went wrong with renew");
            }
