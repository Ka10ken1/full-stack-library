              ...
              <p className="lead">
                ...
                be able to provide the top content for you!
              </p>
                            {
                                ...
                                <Link type="button" className="btn btn-lg main-color text-white" to='search'>Explore top books</Link>
                                :
                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                ...
                                for our Luv 2 Code students! We are diligent about out book selection
                                and out books are always goind to be our top priority
                            </p>
                        </div>
                    </div>
                    <div className="col-sm-6 col-md-6">
